...
def main(video, outpath, height, window_size):
	...
	video_out = cv2.VideoWriter(outpath + "/" + filename + "_unit_flow_overlay.avi", cv2.VideoWriter_fourcc(*'MJPG'), fps, (width, height)) 
	video_out2 = cv2.VideoWriter(outpath + "/" + filename + "_unit_flow_color.avi", cv2.VideoWriter_fourcc(*'MJPG'), fps, (width, height)) 
	video_out3 = cv2.VideoWriter(outpath + "/" + filename + "_unit_flow_strong.avi", cv2.VideoWriter_fourcc(*'MJPG'), fps, (width, height)) 
