...
def main(video, outpath, height, window_size, grid_size, bin_size, wave_dir, mask_path):
	...
	color_wheel = cv2.imread("colorwheel_hue.png")
	...
	while True:
		...
		vis_flow, rip_bins = my_flow.draw_arrows_flow_mask(resized_frame, sum_flow, bin_num, vertices_root_pos_2d, grid_size * 0.8, wave_dir, mask_img, grid_size, threshold_min_mag)
